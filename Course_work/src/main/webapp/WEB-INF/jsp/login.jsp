...
<main style="padding-top: 6rem">
    ...
    <form>
        ...
        <br>
        <button type="submit" class="btn btn-dark mr-0">Войти</button>
        <br>
        <br>
        <small class="form-text text-muted"><a href="${pageContext.request.contextPath}/register">Зарегистрироваться</a></small>
    </form>
    </div>
</main>
<!-- Optional JavaScript -->
